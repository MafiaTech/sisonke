...
{
    /// <inheritdoc />
    public partial class RepairAspNetUsersAuditColumns : Migration
    {
        /// <inheritdoc />
        ...
        {
            migrationBuilder.DropColumn(name: "LastLoginIp", table: "AspNetUsers");
            migrationBuilder.DropColumn(name: "LastLoginAt", table: "AspNetUsers");
            migrationBuilder.DropColumn(name: "DeletedBy", table: "AspNetUsers");
